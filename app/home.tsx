    ...
    <SafeAreaView style={[styles.container, { backgroundColor: themeColors.background }]} edges={['bottom']}>
      ...
      >
        ...
        {!jftLoading && jftReading && (
          <TouchableOpacity
            style={styles.jftTextContainer}
            onPress={handleJFTPress}
            activeOpacity={0.7}
          >
            <Text style={[styles.jftLabel, { color: themeColors.primary }]}>
              Just For Today
            </Text>
        ...
        <TouchableOpacity
          style={[styles.cravingButton, { backgroundColor: themeColors.ctaRed }]}
        ...
        <View style={styles.grid}>
          ...
          <TouchableOpacity
            style={[styles.gridItem, { backgroundColor: themeColors.card, borderColor: themeColors.border }]}
            onPress={() => router.push('/coping-tools')}
            activeOpacity={0.7}
          >
            <IconSymbol
        ...
        <TouchableOpacity
          style={[styles.naMeetingButton, { borderColor: themeColors.border }]}
        ...
        >
          ...
          />
          <Text style={[styles.naMeetingButtonText, { color: themeColors.textSecondary }]}>
            Find NA Meeting
          </Text>
        </TouchableOpacity>
      </ScrollView>
