...
export default function JournalScreen() {
  ...
  const loadEntries = async () => {
    ...
    try {
      ...
      setErrorMessage('Failed to load journal entries. Please try again.');
      setEntries([]);
    } finally {
      setLoading(false);
    }
  ...
  const handleSubmitEntry = async () => {
    if (!selectedMood) {
      setErrorMessage('Please select your mood');
      return;
    }

    console.log('[Journal] Submitting journal entry:', { mood: selectedMood, triggers: selectedTriggers, notes });
    setSubmitting(true);
    setErrorMessage('');
    ...
    <View style={[styles.container, { backgroundColor: themeColors.background }]}>
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.header}>
          <View>
            <Text style={[styles.title, { color: themeColors.text }]}>Daily Journal</Text>
